...
-- 2
CREATE TABLE TB_STUDENT_BASIC_INFO
AS (SELECT STUDENT_NO, STUDENT_NAME, STUDENT_ADDRESS FROM TB_STUDENT);

-- 3
DROP TABLE TB_KUKMOON_STUDENT_INFO;
CREATE TABLE TB_KUKMOON_STUDENT_INFO
AS (SELECT STUDENT_NO, STUDENT_NAME, SUBSTR(STUDENT_SSN,1,4) AS "출생년도", PROFESSOR_NAME
    FROM TB_STUDENT 
