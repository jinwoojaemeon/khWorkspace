...
public class Member {
	...
	public Member(int userNo, String userId, String userPwd, String userName, String gender, int age, String email,
			String phone, String address, String hobby, LocalDateTime emrollDate) {
		super();
		this.userNo = userNo;
		this.userId = userId;
	...
	public LocalDateTime getEmrollDate() {
		return emrollDate;
	}

	public void setEmrollDate(LocalDateTime emrollDate) {
		this.emrollDate = emrollDate;
	}
	...
	public String toString() {
		return "[userNo=" + userNo + ", userId=" + userId + ", userPwd=" + userPwd + ", userName=" + userName
				...
				+ address + ", hobby=" + hobby + ", EMROLL_DATE=" + emrollDate + "]";
	}
