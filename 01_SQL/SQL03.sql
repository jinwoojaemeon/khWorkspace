...
/* 5. 2004년 2학기에 'C3118100'과목을 수강한 학생들의 학점을 조회하려고한다.
        학점이 높은 학생부터 표시하고
        학점이 같으면 학번이 낮은 학생부터 표시하는 구문을 작성하시오.*/
...
/*10. '음악학과' 학생들의 평점을 구하려고 한다. 음악학과 학생들의
        "학번", "학생 이름", "전체 평점"을 출력하는 SQL문장을 작성하시오
        (단, 평점은 소숫점 1자리까지만 반올림하여 표시한다.)             */
SELECT DISTINCT STUDENT_NO, STUDENT_NAME,  ROUND(AVG(POINT),1)
FROM TB_STUDENT
...
--18. 국어국문학과에서 총 평점이 가장 높은 학생의 이름과 학번을 표시하는 SQL을 작성하시오
...
/* 19. 춘 기술대학교의 "환경조경학과"가 속한 같은 계열 학과들의 학과 별 전공과목 평점을 
    ...
    단, 출력헤더는 "계열 학과명", "전공 평점"으로 표시되도록 하고, 
    평점은 소숫점 한 자리까지만 표시되도록 한다.                               */
